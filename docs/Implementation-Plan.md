...
- [x] Connect the confirmed review screen to a clear Start resting action and run controls/status, including a path to review again after a missed start or alarm gate; keep the feasibility console independent.
