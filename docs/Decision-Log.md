...
| --- | --- | --- | --- |
| D-007 | Which Apple voice, locale, base rate, pause conventions, and pronunciation mechanism should be standardized? | Lee/Karen Premium sound substantially more human to the owner (2026-09-21); compact Samantha/Daniel were rejected. Ava/Jamie Premium accent auditions are prepared and verified; listening and selection remain pending. A curated selector is proposed, not implemented or approved as an assumption that all premium voices behave alike. Full-session pronunciation/timing, target-iPhone availability and synthesis, and final selection remain open. | Final narration settings and production playback integration |
