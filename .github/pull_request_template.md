...
<!-- Describe the user-visible outcome and keep the pull request focused. -->

## Privacy, security, and compatibility

<!-- Note data, permission, network, credential, dependency, migration, or compatibility implications. Write "None" when not applicable. -->
...
- [ ] I documented known limitations or follow-up work.
